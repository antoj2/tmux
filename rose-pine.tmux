...
#
#
# slightly modified by me to fit my needs and add mellow variant
...
main() {
    ...
    # display a tiny magnifying glass in the left corner if the window is zoomed (prefix+z)
    left_column=#{?window_zoomed_flag,🔍,}$left_column
